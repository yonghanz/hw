...
# === 繪圖並標記最大值 ===
colors = ['#E69F00', '#D55E00', '#CC79A7', 'gray']
labels = ["1F", "2F", "3F", "TMD"]
...
plt.title("TMD 2 - Displacement with Peak Values")
plt.grid(True)
plt.legend()
plt.tight_layout()

# 儲存圖檔
plt.savefig("/Users/mac/Desktop/hw213/0602/TMD2_Displacement_with_Peaks.png", dpi=300)
...
stats
np.save('/Users/mac/Desktop/hw213/0602/u1_hw6.npy', u1)
np.save('/Users/mac/Desktop/hw213/0602/u2_hw6.npy', u2)
np.save('/Users/mac/Desktop/hw213/0602/u3_hw6.npy', u3)

# === 儲存統計數據 ===
import pandas as pd

df_stats = pd.DataFrame(stats)
df_stats.to_csv("/Users/mac/Desktop/hw213/0602/TMD2_stats.csv", index=False)
print(df_stats)